...
namespace MultiScreenshotCaptureNamespace
{
	...
	public class MultiScreenshotCapture : EditorWindow
	{
		...
		private List<Vector2> resolutions = new List<Vector2>() { new Vector2(1920, 1080), new Vector2(2688, 1242), new Vector2(2208, 1242),new Vector2(2732, 2048) }; // Not readonly to support serialization
		private List<bool> resolutionsEnabled = new List<bool>() { true, true, true, true }; // Same as above
